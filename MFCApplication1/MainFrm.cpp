...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_splitter.CreateView(0,0,RUNTIME_CLASS(CMFCApplication1View),CSize(600,600), pContext);
...
{
	// TODO: Add your message handler code here and/or call default    lpMMI->ptMaxTrackSize.x   =820;   
